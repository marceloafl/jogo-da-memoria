...
export function createLevelHard(){
    ...
    const cardSpringA = createCard('spring');
    const cardSpringAImg = createFrontImg('spring');
    const cardSpringAImgBack = createBackImg();
    cardSpringA.appendChild(cardSpringAImg);
    cardSpringA.appendChild(cardSpringAImgBack);
    board.appendChild(cardSpringA);

    const cardSpringB = createCard('spring');
    const cardSpringBImg = createFrontImg('spring');
    const cardSpringBImgBack = createBackImg();
    cardSpringB.appendChild(cardSpringBImg);
    cardSpringB.appendChild(cardSpringBImgBack);
    board.appendChild(cardSpringB);

    const cardQaA = createCard('qa');
    const cardQaAImg = createFrontImg('qa');
    const cardQaAImgBack = createBackImg();
    cardQaA.appendChild(cardQaAImg);
    cardQaA.appendChild(cardQaAImgBack);
    board.appendChild(cardQaA);

    const cardQaB = createCard('qa');
    const cardQaBImg = createFrontImg('qa');
    const cardQaBImgBack = createBackImg();
    cardQaB.appendChild(cardQaBImg);
    cardQaB.appendChild(cardQaBImgBack);
    board.appendChild(cardQaB);
